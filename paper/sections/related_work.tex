...
Recent advances in egocentric video analysis have introduced large-scale datasets such as EPIC-KITCHENS, Ego4D, and Captain Cook 4D for action recognition and temporal segmentation. Vision-language models like EgoVLP~\cite{egovlp} learn joint embeddings of egocentric videos and natural language through contrastive learning, demonstrating strong zero-shot capabilities. We leverage EgoVLP embeddings to extract semantic visual features from video segments for multimodal alignment with recipe instructions.
