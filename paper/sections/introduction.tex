...
\begin{enumerate}
    ...
    \item A systematic approach for aligning visual observations with recipe steps using Hungarian matching with explicit handling of unmatched procedural steps.
    \item Empirical analysis on Captain Cook 4D revealing limitations of zero-shot unsupervised approaches.
